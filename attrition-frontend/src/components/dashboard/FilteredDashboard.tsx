          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-red-500">{dashboardData.attritionCount}</div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-green-500">{dashboardData.retentionCount}</div>
                </CardContent>
              </Card>
