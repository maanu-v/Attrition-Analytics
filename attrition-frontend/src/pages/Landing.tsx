...
import { BarChart3, MessageSquare, Upload, Building2, HelpCircle } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-gray-900 mb-6">
            Welcome to <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">HR Insights</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Unlock the power of AI-driven HR analytics. Explore workforce trends, predict attrition, and make data-driven decisions with ease.
          </p>
        </div>
          ...
          {navigationCards.map((card) => (
            ...
            >
              <CardContent className="p-8 text-center">
                <div className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-r ${card.gradient} flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="mt-24 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Monitor workforce metrics in real-time with interactive dashboards</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Chat with your data and get instant insights and predictions</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Seamlessly upload and manage your HR datasets</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Scalable solution designed for organizations of all sizes</p>
          </div>
        </div>
      </main>
