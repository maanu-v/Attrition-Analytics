      ...
      <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 shadow-sm">
        ...
        <div className="flex items-center space-x-4">
          <Select value={selectedDataset} onValueChange={setSelectedDataset}>
            ...
            <SelectContent>
              <SelectItem value="HR-Employee-Attrition-All.csv">
                HR-Employee-Attrition-All.csv
              </SelectItem>
              <SelectItem value="Performance_Reviews_2024.csv">
                Performance_Reviews_2024.csv
              </SelectItem>
              <SelectItem value="Salary_Data_2023-2024.csv">
                Salary_Data_2023-2024.csv
              </SelectItem>
            </SelectContent>
          </Select>
